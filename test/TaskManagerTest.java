...
public abstract class TaskManagerTest<T extends TaskManager> {
    ...
    final Task task1 = new Task("AAA", "AAA", Status.NEW);
    final Task task2 = new Task("BBB", "BBB", Status.IN_PROGRESS);
    final Task task3 = new Task("CCC", "CCC", Status.DONE);
    final Epic task4 = new Epic("Epic", 12345, "epic", Status.NEW, LocalDateTime.now(), Duration.ofMinutes(60));
